...
Request.create(user_id: 1, start: DateTime.new(2015, 03, 17, 19, 00, 0), finish: DateTime.new(2015, 03, 17, 22, 00, 0), status: 'accepted', group_ids: [1,2])
...
Request.create(user_id: 2, start: DateTime.new(2015, 04, 05, 18, 00, 0), finish: DateTime.new(2015, 04, 05, 22, 00, 0), status: 'complete', group_ids: [1])